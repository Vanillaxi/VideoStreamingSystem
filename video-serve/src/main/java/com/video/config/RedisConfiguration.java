...
public class RedisConfiguration {
    ...
    static {
        try (InputStream is = RedisConfiguration.class.getClassLoader().getResourceAsStream("properties/Redis.properties")) {
            ...
            if (is != null) {
                ...
                log.warn("未找到 Redis.properties 配置文件，请检查路径: properties/Redis.properties");
            }
